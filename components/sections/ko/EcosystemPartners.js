    ...
    <Row>
      <Col lg={4} md={6} sm={12}>
        <EcosystemPartner name="클레이튼" logo="/static/ecosystem-partners/logo_klaytn.jpg" href="https://www.klaytn.com/">
          클레이튼은 카카오의 블록체인 기술 계열사 그라운드X가 개발한 글로벌 퍼블릭 블록체인 플랫폼으로 블록체인의 대중화를 위해 대규모 이용자를 확보한 블록체인 서비스가 등장해 블록체인 기술의 가치와 유용성을 증명하는 것이 가장 중요하다고 판단하고 있다. 픽션 네트워크는 웹툰 웹소설 등의 창작자와 이용자를 직접 연결하는 새로운 형태의 디지털 콘텐츠 생태계로 블록체인 이용자 확대를 목표로 한다.
        </EcosystemPartner>
      </Col>
      <Col lg={4} md={6} sm={12}>
