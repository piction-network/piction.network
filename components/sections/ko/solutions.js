  ...
  <section id="features">
    ...
    <Row>
      <Col lg={4} md={12}>
        ...
        <ul>
          <li>수익 배분, 분량, 연재방식 등 작품에 대한 모든 것들을 창작자 스스로 자유롭게 결정할 수 있는 권한을 부여합니다.</li>
      ...
      <Col lg={4} md={12}>
        ...
        <ul>
          <li>
          Piction Network에서는 토큰이코노미에 의해, 경제적 인센티브에 기반한 유저들의 참여를 가능하게 합니다. 팬들은 Piction Network에서 마케팅, 홍보, 번역 및 검수 역할을 수행하고, 이러한 노력이 매출로 전환되면 토큰으로 보상 받게됩니다.
          </li>
        </ul>
      </Col>
    </Row>
